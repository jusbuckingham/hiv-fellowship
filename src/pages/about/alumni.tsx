  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Meet the alumni of the HIV Fellowship Program and learn about their contributions to the healthcare industry." />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            {alumni2024.map((alumnus, index) => (
              <div key={index} className="text-center">
                <Image
                  src={alumnus.image}
                  alt={`Portrait of ${alumnus.name}, located in ${alumnus.location}, pronouns: ${alumnus.pronouns}`}
                  width={200}
                  height={200}
