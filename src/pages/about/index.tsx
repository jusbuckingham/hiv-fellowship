    ...
    <>
      ...
      <main className="bg-gray-100">
        ...
        <section className="bg-gray-200 py-16">
          <div className="container mx-auto text-left px-6 md:px-0">
            <h3 className="text-2xl font-bold mb-8 text-center">Program Overview</h3>
            <p className="mb-8">
              <span className="font-bold text-red-600">Year 1</span> focuses on academic coursework through UCLA’s National Clinician Scholars program, covering health policy, research methods, and leadership skills.
            </p>
            <p className="mb-8">
              <span className="font-bold text-red-600">Year 2</span> emphasizes independent patient management in specialty rotations, continuity care, and mentoring.
            </p>
          </div>
        </section>
        <section className="bg-white py-16">
