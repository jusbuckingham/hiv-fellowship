  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Get in touch with the HIV Clinical Leadership Program. We look forward to hearing from you!"
        />
        <meta
          name="keywords"
          content="HIV Clinical Leadership Program, contact, information, healthcare"
        />
      ...
      <main className="bg-white min-h-screen">
        ...
        <section className="container mx-auto px-6 py-24 text-center">
          ...
          <p className="mt-4 text-xl text-gray-700">
            <strong>Shanna Livermore, MPH, MCHES®, FRSPH</strong>
            <br />
            Director of Operations, HIV Clinical Leadership Program
            <br />
            Co-Director, Pacific AIDS Education and Training Center at USC
            <br />
            Email:{' '}
            <a
              href="mailto:shanna.livermore@med.usc.edu"
              className="text-red-600 hover:underline"
            >
              shanna.livermore@med.usc.edu
            </a>
          </p>
        </section>
        ...
        <section className="bg-gray-900 text-white py-20 text-center">
          <h2 className="text-3xl font-bold">
            HIV Clinical Leadership Program<span className="text-red-600">.</span>
          </h2>
          <p className="mt-4 text-xl">
            1000 S. Fremont Ave. Unit 22, Building A-7, 4th Floor
        ...
        <div className="mt-8 mb-8">
          <iframe
            ...
            title="Location Map - 1000 S. Fremont Ave, Alhambra, CA 91803"
            width="100%"
            height="450"
            style={{ border: 0 }}
            allowFullScreen
