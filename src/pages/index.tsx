      ...
      <main className="space-y-24">
        ...
        <section className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col items-center space-y-8">
            <Image src="/images/home/hiv-logo.jpg" alt="HIV Logo" width={200} height={200} className="rounded-full shadow-lg" />
            <h3 className="text-3xl font-semibold text-red-600">An Opportunity to Serve</h3>
            <p className="text-xl max-w-3xl">Over 1.2 million people in the U.S. live with HIV, with more than 35,000 new infections annually. The HIV epidemic continues to affect our communities, particularly vulnerable populations.</p>
            <p className="text-xl max-w-3xl">The HIV Clinical Leadership Program is a postdoctoral fellowship committed to developing HIV specialists focused on addressing health inequities at both individual and systemic levels.</p>
          </div>
        </section>
        ...
        <section className="bg-gray-100 py-24">
          <div className="container mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
              {[
                { title: 'Training & Education', content: 'Fellows train in high-volume HIV clinics, community-based centers, and inpatient services, with specialized curriculum including Addiction Medicine and Gender Affirming Care.' },
                { title: 'Mentorship', content: 'Fellows receive direct clinical and research mentorship, regular leadership meetings, and quarterly career development sessions.' },
                { title: 'Leadership Experience', content: 'In collaboration with UCLA, fellows gain expertise in health policy, research, and leadership, with encouragement to present or publish scholarly projects.' },
                { title: 'Serving Underserved Populations', content: 'Our program is committed to serving vulnerable communities, training fellows in one of the largest safety-net systems in the U.S.' },
              ].map((item, index) => (
        ...
        <section className="container mx-auto py-24 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
            {[
              { src: 'https://www.youtube.com/embed/nnctoOwZw0w', title: 'Dr. Lauren Wolchok: "It’s all about care"' },
              { src: 'https://www.youtube.com/embed/dcdtBS5A9aM', title: 'HIV Fellowship 2021' },
            ].map((video, index) => (
              <div key={index} className="relative w-full overflow-hidden rounded-lg shadow-lg">
                <iframe className="w-full h-64 sm:h-80 md:h-96" src={video.src} title={video.title} frameBorder="0" allowFullScreen></iframe>
              </div>
            ))}
          </div>
        </section>
